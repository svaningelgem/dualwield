...
public final class NMS_v1_13_R1 implements NMS {
    @Override
    ...
    public float getBlockHardness(org.bukkit.block.Block block) {
        ...
        return nmsBlock.d(null, null, null);
    }
    ...
    public void setModifier(Player player, double damage, double speed, UUID uuid) {
        ...
        AttributeInstance speedAttributeInstance = entityPlayer.getAttributeInstance(GenericAttributes.g);
